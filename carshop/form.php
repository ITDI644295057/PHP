        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 "> 
                    ...
                    <form  action="condb.php" method="post" enctype="multipart/form-data">        
                        ยี่ห้อ : <input  class="form-control" type="text" name="brand" required><br>      
                        สี : <input  class="form-control" type="text" name="color" required><br> 
                        ทะเบียน : <input  class="form-control" type="text" name="register" required><br> 
                        ราคา : <input  class="form-control" type="number" name="price" required> <br>
                        อัปโหลดรูปรถ :   <input  type="file" name="carimage" accept="image/*"><br><br>   
